...
class AudioVideoStreamer:
    def __init__(
        self,
        audio_callback: Optional[ProcessingCallback],
        audio_input_device: str,
        audio_output_buffersize: int,
        audio_output_device: str,
        audio_processing_size: int,
        ...
        use_audio: bool,
        use_video: bool,
        video_callback: Optional[ProcessingCallback],
        video_input_device_index: int,
        video_maximum_fps: int,
        video_output_virtual_cam: bool,
        video_output_window: bool,
        video_processing_size: int,
    ):
        """
        ...
        :param audio_input_device: Name of the pyaudio input device.
        :param audio_output_buffersize: Size of the system output buffer.
        :param audio_output_device: Name of the pyaudio output device.
        ...
        :param video_input_device_index: Index of the opencv input device.
        :param video_output_virtual_cam: Activate output to virtual cam.
        :param video_output_window: Activate output to window.
        ...
        if use_audio:
            ...
            audio_processor = AudioProcessor(
                ...
                pyaudio_input_device_index=get_device_idx(audio_input_device),
                sampling_rate=audio_sampling_rate,
                record_buffersize=audio_record_buffersize,
                pyaudio_output_device_index=get_device_idx(audio_output_device),
        ...
        if use_video:
            ...
            video_processor = VideoProcessor(
                ...
                opencv_input_device_index=video_input_device_index,
